...
export const LoadTextures = (imagePaths: string[]) => {
  const textureLoader = new THREE.TextureLoader();
  const textures: Record<string, THREE.Texture> = {};

  imagePaths.forEach((img: string) => {
    const path = `/assets/scroll/${img}.png`;
...
export const LoadAnimations = (
  scene: THREE.Scene,
  colors: { cristal: string; soda: string },
  cristalMaterial: THREE.MeshStandardMaterial,
